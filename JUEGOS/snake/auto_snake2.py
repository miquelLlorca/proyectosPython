...
while not hecho:
    ...
    if not perder:
        if cola[0][0] - posCom[0] != 0 and cola[0][1] - posCom[1] != 0:
            if abst(cola[0][0] - posCom[0]) < abst(cola[0][1] - posCom[1]):
                if cola[0][0] - posCom[0] < 0:
                    vel = [-1, 0]
                else:
                    vel = [1, 0]
            elif abst(cola[0][0] - posCom[0]) > abst(cola[0][1] - posCom[1]):
                if cola[0][1] - posCom[1] < 0:
                    vel = [0, -1]
                else:
                    vel = [0, 1]
        elif cola[0][0] - posCom[0] == 0 and cola[0][1] - posCom[1] != 0:
            if cola[0][1] - posCom[1] < 0:
                vel = [0, -1]
            else:
                vel = [0, 1]
